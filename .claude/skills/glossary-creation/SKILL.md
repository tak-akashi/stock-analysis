...
1. **docs/core/product-requirements.md** (PRD)
2. **docs/core/functional-design.md** (機能設計書)
3. **docs/core/architecture.md** (アーキテクチャ設計書)
4. **docs/core/repository-structure.md** (リポジトリ構造)
5. **docs/core/development-guidelines.md** (開発ガイドライン)
