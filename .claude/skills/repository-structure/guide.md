...
# services/task_service.py
from protocols.service_protocols import IUserService
...
# services/user_service.py
from protocols.service_protocols import ITaskService
...
**ソースコード内**:
- Google Style Docstring: 関数・クラスの説明
