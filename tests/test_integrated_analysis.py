...
class TestIntegratedAnalysis:
    ...
    def temp_results_database(self):
        ...
        for days_back in range(1, 6):
            test_date_ts = (
                datetime.datetime(2023, 12, 1) - datetime.timedelta(days=days_back)
            ).strftime("%Y-%m-%d")

            for i, code in enumerate(
                ["1001", "1002"]
            ):  # Just two codes for time series
    ...
    def test_get_comprehensive_analysis_single_code(self, temp_results_database):
        ...
        result = get_comprehensive_analysis(
            "2023-12-01", code="1001", db_path=temp_results_database
        )
    ...
    def test_get_multi_date_analysis(self, temp_results_database):
        ...
        result = get_multi_date_analysis(
            "2023-11-26", "2023-12-01", "1001", db_path=temp_results_database
        )
    ...
    def test_get_multi_date_analysis_no_data(self, temp_results_database):
        ...
        result = get_multi_date_analysis(
            "2024-01-01", "2024-01-02", "1001", db_path=temp_results_database
        )
    ...
    def test_get_top_stocks_by_hl_ratio(self, temp_results_database):
        ...
        result = get_top_stocks_by_criteria(
            "2023-12-01", criteria="hl_ratio", limit=3, db_path=temp_results_database
        )
    ...
    def test_get_top_stocks_by_rsi(self, temp_results_database):
        ...
        result = get_top_stocks_by_criteria(
            "2023-12-01", criteria="rsi", limit=3, db_path=temp_results_database
        )
    ...
    def test_get_top_stocks_by_minervini(self, temp_results_database):
        ...
        result = get_top_stocks_by_criteria(
            "2023-12-01", criteria="minervini", limit=3, db_path=temp_results_database
        )
    ...
    def test_get_top_stocks_by_composite(self, temp_results_database):
        ...
        result = get_top_stocks_by_criteria(
            "2023-12-01", criteria="composite", limit=3, db_path=temp_results_database
        )
    ...
    def test_get_top_stocks_invalid_criteria(self, temp_results_database):
        ...
        with pytest.raises(ValueError):
            get_top_stocks_by_criteria(
                "2023-12-01", criteria="invalid", db_path=temp_results_database
            )
