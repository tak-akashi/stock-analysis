...
from core.analysis.minervini import MinerviniConfig, MinerviniDatabase  # noqa: E402
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler(f'test_type8_{datetime.now().strftime("%Y%m%d_%H%M%S")}.log')
        ]
    )
